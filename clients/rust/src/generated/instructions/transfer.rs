...
/// ### Accounts:
///
///   0. `[writable, signer, optional]` relayer (default to `re1R63DiMLtDyHMAS1ohszqfFTHcF9Q3uEXSYdHzHWU`)
///   1. `[writable]` pool
///   2. `[writable]` mint
///   3. `[writable]` vault
...
///   8. `[writable, optional]` fee_collector (default to `9qX97Bd8dvHAknHVjCxz4uEJcPSE3NGjjgniMVdDBu6d`)
...
impl TransferBuilder {
  ...
  /// `[optional account, default to 're1R63DiMLtDyHMAS1ohszqfFTHcF9Q3uEXSYdHzHWU']`
  #[inline(always)]
  ...
  /// `[optional account, default to '9qX97Bd8dvHAknHVjCxz4uEJcPSE3NGjjgniMVdDBu6d']`
  #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Transfer {
      relayer: self.relayer.unwrap_or(solana_pubkey::pubkey!(
      ...
      fee_collector: self.fee_collector.unwrap_or(solana_pubkey::pubkey!(
