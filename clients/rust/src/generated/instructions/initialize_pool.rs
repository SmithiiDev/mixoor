...
/// ### Accounts:
///
///   0. `[writable, signer, optional]` authority (default to `re1R63DiMLtDyHMAS1ohszqfFTHcF9Q3uEXSYdHzHWU`)
///   1. `[writable]` pool
///   2. `[writable]` vault
///   3. `[writable]` vault_ata
///   4. `[writable]` mint
///   5. `[optional]` fee_collector (default to `9qX97Bd8dvHAknHVjCxz4uEJcPSE3NGjjgniMVdDBu6d`)
