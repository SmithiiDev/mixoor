...
/// ### Accounts:
///
///   0. `[writable, signer, optional]` authority (default to `AdUKMLxLi18EfLqLFQvDaizXmvGoDFaNQfQU681vbTje`)
///   1. `[writable]` pool
///   2. `[writable]` vault
///   3. `[]` vault_ata
...
impl WithdrawBuilder {
  ...
  /// `[optional account, default to 'AdUKMLxLi18EfLqLFQvDaizXmvGoDFaNQfQU681vbTje']`
  #[inline(always)]
